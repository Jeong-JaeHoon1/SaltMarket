<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="java.util.ArrayList, com.saltmarket.common.model.vo.Region, com.saltmarket.product.model.vo.WishList,
com.saltmarket.product.model.vo.Product" %>
<%
...
<head>
    ...
    <style>
        ...
        .buyList>div { display: inline-block; }
                ...
                <nav>
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="<%= contextPath %>/myPageBuyList.me">구매내역</a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="buyList">
	                ...
	                <% } else { %>
	                	<% for(Product p : buyList) { %>
		                    <div class="thumbnail">
		                    	<img class="pro-img" src="<%= contextPath %>/<%= p.getTitleImg() %>" width="130" height="130">
		                        <div class="pro-dsc">
