...
<title>상품등록페이지</title>
	...
	<!-- 외부 css -->
   <link href="<%=request.getContextPath()%>/resources/css/productRegistration.css" rel="stylesheet" type="text/css">
...
<body>
	...
	<form id="productrRegistration-form" action="<%= contextPath %>/productInsert.pr" method="post"  enctype="multipart/form-data">
		...
		<br><br>
			<div class="container" id="product-title">
					<div class="row">
						...
						<div class="col-9">
								<input type="text" id="productName" name="productName"  placeholder="상품 제목을 입력해주세요" required>
								&nbsp;&nbsp;
		...
		<div class="container" id="sellPrice">
			<div class="row">
					...
					<div class="col-9">
						<input type="number" min="0" step="10" name="price" placeholder="숫자만 입력해주세요" required><h4>원</h4>
						&nbsp;&nbsp;
			...
			<div class="container" id="content">
					<div class="row">
						...
						<div class="col-9">
							<textarea type="content" rows="10" cols="80" id="description" name="description" placeholder="상품 설명을 입력해주세요(2000자 이내)"></textarea>
						</div>
					</div>
			</div>
