<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import= "java.util.ArrayList, com.saltmarket.member.model.vo.*, com.saltmarket.notice.model.vo.*"  %>
<%
                ...
                <div id="layoutSidenav_content">
                    <main>
                        <div class="container-fluid px-4">
                            <h1 class="mt-4">공지사항 관리
                            </h1>                
                            <div style="display: flex; justify-content: end; margin-bottom: 20px;">
                                <a class="btn btn-primary" href="<%= contextPath %>/enroll.no" role="button">공지사항 작성</a>
                            </div>
                            <div class="card mb-4">
                                            ...
                                            <% if(list != null) { %>
                                                <% for(Notice n : list) { %>
                                                    <tr>
                                                        ...
                                                        <td><%= n.getDeleteStatus() %></td>
                                                        <td>
                                                            <a class="btn btn-warning" href="<%= contextPath %>/updateForm.no?nno=<%= n.getNoticeNo() %>" role="button">수정</a>
                                                            <a class="btn btn-danger" href="<%= contextPath %>/delete.no?nno=<%= n.getNoticeNo() %>" role="button">삭제</a>
                                                        </td>
                                                    </tr>
                                                <% } %>
                                            <% } %>
            ...
            <script>
                ...
                $(function() {
                    $("#datatablesSimple").on('click', 'tbody tr', function () {
                        ...
                        location.href = "<%= contextPath %>/detail.mno?nno="+nno;
                    });
                });
            </script>
            <script>
