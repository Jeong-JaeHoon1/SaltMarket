 ...
 */
@WebServlet("/manageUpdateForm.fbo")
public class FreeboardManageUpdateFormController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FreeboardManageUpdateFormController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 수정하기 페이지로 포워딩
		request.getRequestDispatcher("views/dashboard/freeboardManageUpdateForm.jsp").forward(request, response);
	}
