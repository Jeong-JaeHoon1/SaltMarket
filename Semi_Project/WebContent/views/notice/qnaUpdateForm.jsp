        ...
        <div id="its">
            <div class="container container2" style="height: 1100px; display: flex; padding: 0px;">
                ...
                <div style="background-color: white; margin-top: 80px; box-shadow: 5px 5px 10px 5px gray; width: 970px;">
                    <form action="<%= contextPath %>/update.qna?qno=<%= q.getQnaNo() %>" method="post" enctype="multipart/form-data">
                        ...
                        <div style="display: flex; flex-direction: column; padding: 40px; ">
                            ...
                            <div style="height: 100px; display: flex;">
                                ...
                                <input name="title" type="text" style="width: 700px; height: 40px; " required value=" <%= q.getqTitle() %> ">
                            </div>
                            <div style="height: 350px; display: flex">
                                <span style="width:140px ;font-size: 20px">문의 내용</span>
                                <textarea name="content" id="" cols="30" rows="10" style="width: 700px; height: 300px; resize: none;" required  > <%= q.getqContent() %> </textarea>
                            </div>
                            <div  style="height: 300px; display: flex; flex-wrap: nowrap;">
                                ...
                                <% } else if(list == null){ %>
                                        <div style="border: 1px solid rgb(133, 133, 133); width: 200px; height: 200px; margin-right: 50px; border-radius: 1px;">
                                            <img id="contentImg0" width="100%" height="100%">
                                        </div>
                                        <div style="border: 1px solid rgb(133, 133, 133); width: 200px; height: 200px; margin-right: 50px; border-radius: 1px;">
                            ...
                            <div class="file-area">
                                <input type="file" id="file0" name="reUpfile0" onchange="loadImg(this, 1);">
                                <input type="file" id="file1" name="reUpfile1" onchange="loadImg(this, 2);">
                                <input type="file" id="file2" name="reUpfile2" onchange="loadImg(this, 3);">
                            </div>
                            <div style="height: 300px; display: flex ; justify-content: center;">
                                <button type="submit" style="width: 265px; height: 60px; background-color: black; color: white; font-size: 25px; font-weight: 900;">수정하기</button>
                            </div>
                        </div>
                    </form>
                </div>
