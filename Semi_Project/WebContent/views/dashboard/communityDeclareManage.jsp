                        ...
                        <div class="sb-sidenav-menu">
                            <div class="nav">
                                ...
                                <div class="collapse" id="collapseLayouts_co" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                    <nav class="sb-sidenav-menu-nested nav">
                                        <a class="nav-link" href="freeBoardManage.jsp">
                                            <div class="sb-nav-link-icon"><i class="fas fa-table"></i></div>
                                            자유게시판 관리
                                        </a>
                                        
                                        <a class="nav-link" href="shareBoardManage.jsp">
                                            <div class="sb-nav-link-icon"><i class="fas fa-table"></i></div>
                                            나눔게시판 관리
                                        </a>

                                        <a class="nav-link" href="replyManage.jsp">
                                            <div class="sb-nav-link-icon"><i class="fas fa-table"></i></div>
                                            댓글 관리
                                        </a>

                                        <a class="nav-link" href="reviewManage.jsp">
                                            <div class="sb-nav-link-icon"><i class="fas fa-table"></i></div>
                                            후기 관리
                                        </a>
                                    </nav>
