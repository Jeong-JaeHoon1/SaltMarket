...
public class AjaxShareboardReplyInsertController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AjaxShareboardReplyInsertController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		r.setShareboardNo(boardNo);
		r.setUserNo(userNo);
		
		// 서비스로 요청 후 결과 받기
		int result = new ShareboardService().insertReply(r);
