 ...
 */
@WebServlet("/manageUpdateForm.sbo")
public class ShareboardManageUpdateFormController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ShareboardManageUpdateFormController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 수정하기 페이지로 포워딩
		request.getRequestDispatcher("views/dashboard/shareboardManageUpdateForm.jsp").forward(request, response);
	}
