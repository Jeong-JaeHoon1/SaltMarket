 ...
 */
@WebServlet("/manage.sbo")
public class ShareboardManageController extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * Default constructor. 
     */
    public ShareboardManageController() {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int endPage = startPage + pageLimit - 1;
		 ...
		 request.getRequestDispatcher("views/dashboard/shareboardManageList.jsp").forward(request, response);
