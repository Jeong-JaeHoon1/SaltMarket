<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="com.saltmarket.member.model.vo.Member, com.saltmarket.common.model.vo.*, java.util.ArrayList" %>
                                            ...
                                            <% if(!list.isEmpty()) {%>                                    
                                                <% for(Declaration d : list) {%>
                                                    <tr>
                                                        ...
                                                        <td><%= d.getUserId() %></td>
                                                        <td><%= d.getDeclareType() %></td>
                                                        <td><%= d.getDeclareTitle() %></td>
                                                        <td><%= d.getDeclareDate() %></td>
                                                        <td>
            ...
            <script>
                $(function() {
                    $("#datatablesSimple").on('click', 'tbody tr', function () {
                        ...
                        location.href = "<%= contextPath %>/detail.dc?dno="+dno+"&type="+type;
                    });
                });
            </script>
        </body>
