<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="java.util.ArrayList, com.saltmarket.member.model.vo.Member, com.saltmarket.product.model.vo.Product" %>
<%
                                            ...
                                            <% if(plist != null) { %>
                                                <% for(Product p : plist) { %>
                                                    <tr>
                                                        ...
                                                        <td><%= p.getDeleteStatus() %></td>
                                                        <td>
                                                            <a class="btn btn-danger" href="<%= contextPath %>/detail.pr?pno=<%= p.getProductNo() %>" role="button">매물보기</a>
                                                        </td>
                                                    </tr>
                                                <% } %>
                                            <% } %>
