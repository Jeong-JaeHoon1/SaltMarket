            ...
            <div id="board-bottom">
                ...
                <div id="update-delete">
                	...
                	<button type="button" class="btn btn-danger btn-sm" style="text-align: center; margin-right:10px;" 
                		onclick="location.href='<%= contextPath %>/reportForm.bo?bno=<%= sb.getShareboardNo() %>&type=share'">신고</button>
                	<% } %>
                    ...
                    <% if(
	                    ...
	                    <button type="button" class="btn-margin btn btn-outline-primary btn-sm"
	                        onclick="location.href='<%= contextPath %>/updateForm.sbo?bno=<%= sb.getShareboardNo() %>'">수정</button>
						...
						<script>
							...
							function showConfirmationModal(shareboardNo) {
							  ...
							  function deleteForm() {
								  ...
								  location.href = '<%= contextPath %>/delete.sbo?bno=' + shareboardNo;
								  $('#deleteFormModal').modal('hide');
							  }
						</script>
