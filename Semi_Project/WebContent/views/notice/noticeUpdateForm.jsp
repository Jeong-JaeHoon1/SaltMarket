                        ...
                        <div style="padding: 30px;">
                            <form action="<%= contextPath %>/update.no" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="제목" name="title" required value="<%= n.getNoticeTitle() %>">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleFormControlTextarea1" class="form-label" >공지사항 내용</label>
                                    <textarea class="form-control"name="content" id="" cols="30" rows="10" style=" height: 300px; resize: none;" required > <%= n.getNoticeContent() %></textarea>
                                </div>
                                ...
                                <div style="height: 300px; display: flex ; justify-content: center;">
                                    <button type="submit" style="width: 265px; height: 60px; background-color: black; color: white; font-size: 25px; font-weight: 900;">공지사항 수정</button>
                                </div>
                            </form>
                        </div>
                    </div>
