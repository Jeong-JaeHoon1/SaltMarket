        ...
        <div id="center">
            ...
            <div id="board-bottom">
                ...
                <div id="update-delete">
                    <a href="javascript:history.back()" class="btn btn-secondary btn-sm" style="text-align: center;">이전으로</a>
                    ...
                    <% if(
	                    ...
	                    <button type="button" class="btn-margin btn btn-outline-primary btn-sm"
	                        onclick="location.href ='<%= contextPath %>/manageUpdateForm.fbo?bno=<%= fb.getFreeboardNo() %>'">수정</button>
